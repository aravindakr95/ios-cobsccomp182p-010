...
class ResetPasswordViewController: UIViewController {
    ...
    @IBAction func onResetPassword(_ sender: NEButton) {
        ...
        authManager.sendPasswordReset(emailField: txtEmail) {[weak self] (success, error) in
            ...
            if (error != nil) {
                ...
                alert = NotificationManager.showAlert(header: "Email Sent", body: "We have sent a password reset instructions to your \(self.txtEmail.text!) email address.", action: "Okay", handler: {(_: UIAlertAction!) in
