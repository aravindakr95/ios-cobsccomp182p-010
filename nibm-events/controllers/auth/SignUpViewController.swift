...
class SignUpViewController: UIViewController {
    ...
    @IBOutlet weak var txtIndexNumber: NETextField!
    ...
    private func configureStyles() {
        ...
        self.txtIndexNumber.setLeftPaddingPoints(5)
        self.txtIndexNumber.setRightPaddingPoints(5)
    }
        ...
        authManager.createUser(emailField: txtEmail, passwordField: txtPassword) {[weak self] (userData, error) in
            ...
            if (error != nil) {
                ...
                let data: Dictionary<String, String> = [
                    ...
                    "indexNumber": self.txtIndexNumber.text!
                ]
