...
final class AuthManager {
    public func createUser(emailField: NETextField, passwordField: NETextField, completion: @escaping (_ success: User?, _ error: String?) -> Void) {
        guard
    ...
    public func signIn(emailField: NETextField, passwordField: NETextField, completion: @escaping (_ success: Bool?, _ error: String?) -> Void) {
        guard
            let email = emailField.text,
            let password = passwordField.text
            else { return }
